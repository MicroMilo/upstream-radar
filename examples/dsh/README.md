...
The checked-in [result](reports/headless-smoke.json) is generated by `pnpm run try:dsh:report`. It proves the DSH handoff and result-writeback plumbing, not model analysis quality or live-advisory freshness.
