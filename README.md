...
```bash
npx --yes upstream-radar@0.33.3 inspect dsh-feishu-bot@0.15.4 --deep
```
...
```bash
npx --yes upstream-radar@0.33.3 inspect \
...
pnpm dlx --package=upstream-radar@0.33.3 upstream-radar graph pnpm-lock pnpm-lock.yaml --json
```
...
```bash
pnpm dlx --package=upstream-radar@0.33.3 upstream-radar probe dsh-matrix \
  ./dsh-plugin-1.2.3.tgz \
